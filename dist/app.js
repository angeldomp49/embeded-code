...
/*!**************************!*\
  ...
  \**************************/
/*! namespace exports */
/*! export alwaysWeekDay [provided] [no usage info] [missing usage info prevents renaming] */
/*! export firstWeekDayMonth [provided] [no usage info] [missing usage info prevents renaming] */
/*! export firstWeekDayYear [provided] [no usage info] [missing usage info prevents renaming] */
...
/* harmony export */   "alwaysWeekDay": () => /* binding */ alwaysWeekDay,
/* harmony export */   "isLeapYear": () => /* binding */ isLeapYear,
/* harmony export */   "firstWeekDayYear": () => /* binding */ firstWeekDayYear,
/* harmony export */   "firstWeekDayMonth": () => /* binding */ firstWeekDayMonth
/* harmony export */ });
/* harmony import */ var _Constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Constants */ "./src/Constants.js");
;
function alwaysWeekDay(day) {
  return day >= 7 ? day - 7 : day;
}
function isLeapYear(year) {
  return year % 4 == 0 ? true : false;
}
function firstWeekDayYear(year) {
  var offset = _Constants__WEBPACK_IMPORTED_MODULE_0__.FIRST_DATE.WEEK_DAY;

  for (var i = _Constants__WEBPACK_IMPORTED_MODULE_0__.FIRST_DATE.YEAR; i < year; i++) {
    offset++;
...
function firstWeekDayMonth(month, year) {
  var firstDay = firstWeekDayYear(year);
  ...
  for (var i = 0; i < month; i++) {
    ...
    firstDay += _Constants__WEBPACK_IMPORTED_MODULE_0__.MONTHS[i].DAYS - 28;
...
/*!**************************!*\
  ...
  \**************************/
/*! namespace exports */
/*! export FIRST_DATE [provided] [no usage info] [missing usage info prevents renaming] */
/*! export MONTHS [provided] [no usage info] [missing usage info prevents renaming] */
/*! export WEEK_DAYS [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "FIRST_DATE": () => /* binding */ FIRST_DATE,
...
var DateForm = /*#__PURE__*/function (_React$Component) {
  _inherits(DateForm, _React$Component);

  var _super = _createSuper(DateForm);
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("form", {
        ...
        onClick: function onClick() {
          _this.props.activateDatepicker();
        }
      }, "afdffdfd"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
        type: "hidden",
        value: ""
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DateForm);
...
/* harmony import */ var _Calculate__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Calculate */ "./src/Calculate.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      ...
      methods: {
        prevMonth: function prevMonth() {
          if (_this.state.members.actualMonth == 0) {
            _this.setState({
              actualMonth: 11
            }, _this.state.methods.updateDaysCalendar);
          } else {
            _this.setState({
              actualMonth: _this.state.members.actualMonth - 1
            }, _this.state.methods.updateDaysCalendar);
          }
        },
        nextMonth: function nextMonth() {
          if (_this.state.members.actualMonth == 11) {
            _this.setState({
              actualMonth: 0
            }, _this.state.methods.updateDaysCalendar);
          } else {
            _this.setState({
              actualMonth: _this.state.methods.actualMonth + 1
            }, _this.state.methods.updateDaysCalendar);
          }
        },
        fillCalendar: function fillCalendar(actualMonth, actualYear) {
          var i = 0;
          var dayMonth = 1;
          var rows = [];
          var numberDays = _Constants__WEBPACK_IMPORTED_MODULE_1__.MONTHS[actualMonth].DAYS;
          var offset = _Calculate__WEBPACK_IMPORTED_MODULE_2__.firstWeekDayMonth(actualMonth, actualYear);
          var totalBoxes = numberDays + offset - 1;

          if (_Calculate__WEBPACK_IMPORTED_MODULE_2__.isLeapYear(actualYear) && actualMonth == 1) {
            totalBoxes++;
          }
        ...
        DaysTable: function DaysTable(arrayDays) {
          return arrayDays.map(function (row, index) {
        ...
        selectDay: function selectDay(numberDay) {},
        changeYear: function changeYear(e) {
          _this.setState({
            actualYear: e.target.value
          }, _this.state.methods.updateDaysCalendar);
        },
        updateDaysCalendar: function updateDaysCalendar() {
          var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
          var _this$state$members = _this.state.members,
              actualMonth = _this$state$members.actualMonth,
              actualYear = _this$state$members.actualYear;
          var _this$state$methods = _this.state.methods,
              DaysTable = _this$state$methods.DaysTable,
              fillCalendar = _this$state$methods.fillCalendar;

          _this.setState({
            daysCalendar: DaysTable(fillCalendar(actualMonth, actualYear))
          }, callback);
        },
        loadAppointments: function loadAppointments() {},
        testComponent: function testComponent() {
          console.log(_this.state.members.actualMonth);
          console.log(_this.state.members.actualYear);
          console.log(_this.state.methods.fillCalendar(_this.state.members.actualMonth, _this.state.members.actualYear));
          console.log(_this.state.methods.DaysTable(_this.state.methods.fillCalendar(_this.state.members.actualMonth, _this.state.members.actualYear)));
        }
      }
    });
  ...
  _createClass(DatePicker, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("form", {
        className: (this.props.className ? this.props.className : "") + (this.props.active ? "active" : "default")
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
        className: "mt_ec_dp_form_section"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", {
        onClick: function onClick(e) {
          e.preventDefault();

          _this2.state.methods.prevMonth();
        }
      }, "prev"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", null, _Constants__WEBPACK_IMPORTED_MODULE_1__.MONTHS[this.state.members.actualMonth].NAME), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("select", {
        onChange: function onChange(e) {
          _this2.setState({
            actualYear: e.target.value
          }, _this2.state.methods.updateDaysCalendar);
        },
        name: "mt_ec_dp_year",
        id: "mt_ec_dp_year",
        value: this.state.members.actualYear
      }, this.state.members.years.map(function (year) {
        ...
        onClick: function onClick(e) {
          ...
          _this2.state.methods.nextMonth();
        }
      }, "next")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
        className: "mt_ec_dp_form_section"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("table", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("thead", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("tr", null, _Constants__WEBPACK_IMPORTED_MODULE_1__.WEEK_DAYS.map(function (day) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("td", {
          key: day.ID
        }, day.NAME);
      }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("tbody", null, this.state.members.daysCalendar))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
        className: "mt_ec_dp_form_section"
      })));
    }
  }]);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _DateForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DateForm */ "./src/DateForm.js");
/* harmony import */ var _DatePicker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DatePicker */ "./src/DatePicker.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var Root = /*#__PURE__*/function (_React$Component) {
      ...
      methods: {
        datePicker: {
          activate: function activate() {
            var rest = _extends({}, _this.state.members);

            var _this$state$members$d = _this.state.members.datePicker,
                active = _this$state$members$d.active,
                rest2 = _objectWithoutProperties(_this$state$members$d, ["active"]);
            ...
            _this.setState({
              ...
              console.log(_this.state.members.datePicker.active);
            });
          }
        }
      }
  ...
  _createClass(Root, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_DateForm__WEBPACK_IMPORTED_MODULE_1__.default, {
        className: "",
        activateDatepicker: this.state.methods.datePicker.activate
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
        type: "text",
        name: "name",
        placeholder: "name"
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_DatePicker__WEBPACK_IMPORTED_MODULE_2__.default, {
        className: "",
        active: this.state.members.datePicker.active
      }));
    }
  }]);
...
window.addEventListener("load", function () {
  react_dom__WEBPACK_IMPORTED_MODULE_1__.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Root__WEBPACK_IMPORTED_MODULE_2__.default, null), document.querySelector("#root"));
}, false);
